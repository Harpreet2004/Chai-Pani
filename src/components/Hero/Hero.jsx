...
function Hero() {
  return (
    <main className="bg-secondary h-[36rem] max-lg-tablet:h-[30rem] max-md:bg-[url('/src/images/hero-img.png')] max-md:bg-center max-md:bg-cover max-md:shadow-bg-box max-[414px]:h-[32rem]">
      <div className=" flex justify-center items-center gap-56 pt-12 max-lg-desktop:gap-16   max-sm-laptop:pt-20 max-lg-tablet:gap-0">
        ...
        <div className="flex ">
          <img
            ...
            src="/images/hero-img-BKzczMrL.png"
            alt="hero-img"
          />
        </div>
      </div>
