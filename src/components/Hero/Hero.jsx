...
function Hero() {
  return (
    <main className="bg-secondary h-[36rem] max-lg-tablet:h-[30rem] max-md:bg-[url('/assets/hero-img.png')] max-md:bg-center max-md:bg-cover max-md:shadow-bg-box max-[414px]:h-[32rem]">
