...
function About() {
  return (
    <section className="bg-light h-[36rem] pb-[50rem] max-md:pb-[43rem] max-[1020px]:pb-[53rem]">
      <div className="flex justify-center items-center gap-36 pt-10 px-56 max-lg-desktop:px-20 max-sm-laptop:gap-14 max-lg-tablet:gap-20 max-md:gap-14 max-md:px-28 max-sm:relative max-sm:px-20 max-[1020px]:pt-20  ">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex justify-start items-start pb-36 max-sm:flex max-sm:justify-center max-sm:items-center max-sm:mt-5 max-sm:pb-10">
